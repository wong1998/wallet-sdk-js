...
export function mnemonicToSeed (mnemonic: any, password: any) {
    return bip39.mnemonicToSeed(mnemonic, password);
}

export function mnemonicToSeedSync (mnemonic: any, password: any) {
    return bip39.mnemonicToSeedSync(mnemonic, password);
}

export function validateMnemonic (mnemonic: any, language: any) {
    switch (language) {
        case 'chinese_simplified':
